...
//   return (
//     <div 
//       onClick={() => { handleFetchProject(project.id); setIsProjectDetailModal(true) }} 
//       className="group relative w-full h-100 rounded-3xl overflow-hidden bg-gray-100 dark:bg-gray-900 border border-gray-200/50 dark:border-gray-800/50 shadow-sm transition-all duration-500 ease-out hover:scale-[1.02] hover:shadow-xl dark:shadow-black/40 cursor-pointer"
//     >

//       {/* Render image only if it exists AND hasn't failed to load */}
...
//           alt={project.name || "Project Preview"}
//           loading="lazy"
//           onError={() => setImageError(true)} // Gracefully fall back if image link is broken
//         />
//       ) : (
//         <div className="flex h-full w-full flex-col items-center justify-center gap-2 text-gray-400 dark:text-gray-500">
//           <FolderGit2 className="w-10 h-10 stroke-[1.5]" />
