...
const SkillCard = ({ skill }) => {
  ...
  return (
    <div className="group relative flex flex-col items-center justify-center p-6 w-full min-h-[14rem] rounded-2xl bg-white dark:bg-gray-700/10 border border-gray-100 dark:border-gray-800/60 shadow-sm transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-md hover:border-blue-500/30 dark:hover:border-blue-500/30">
      
      {/* Delete Button Container */}
      <div className="absolute top-3 right-3 group inline-block">
        <button 
          onClick={() => handleDeleteSkill(skill.id)}
