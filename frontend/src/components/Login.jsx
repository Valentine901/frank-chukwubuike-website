...
import { Moon, Sun, Mail, Lock, Eye, EyeClosed, ArrowRightIcon } from "lucide-react";
            ...
            <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-md md:max-w-4xl gap-8 md:gap-16 mt-12 md:mt-0">
                ...
                <div className="w-full md:w-1/2 flex justify-center">
                    <form className="flex flex-col border-gray-500 border rounded-2xl px-4 py-8 bg-gray-100 dark:bg-gray-700 w-full max-w-md" onSubmit={handleSubmitLoginForm}>
                        ...
                        <button className="w-full flex items-center justify-center gap-4 rounded-md p-2 bg-blue-600 hover:bg-blue-700 font-heading text-lg text-gray-100 transition-all duration-300 cursor-pointer" type="submit" disabled={loading}>
